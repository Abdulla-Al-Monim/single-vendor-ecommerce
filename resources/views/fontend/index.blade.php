                        ...
                        <div class="container-fluid">
                            <div class="caption bg-color vertical-center text-left">
                                ...
                                <div class="slider-header fadeInDown-1">
                                    @if (session()->get('language') == 'bangla') স্বপ্ন @else sopno @endif
                                </div>
                                @endif
                                <div class="big-text fadeInDown-1">
                                    @if (session()->get('language') == 'bangla'){{  $slider->title_bn  }}  @else {{ $slider->title_en }} @endif
                                </div>
                                <div class="excerpt fadeInDown-2 hidden-xs">

                                <span>  @if (session()->get('language') == 'bangla'){{  $slider->description_bn  }}  @else {{  $slider->description_en  }} @endif </span>
        ...
        <div class="product-slider">
            <div class="owl-carousel home-owl-carousel custom-carousel owl-theme" data-item="4">
                ...
                <div class="item item-carousel">
                    ...
                    @empty
                    <h5 class="text-danger">   @if (session()->get('language') == 'bangla')
                        দুঃখিত কোনো পণ্য পাওয়া যায়নি @else No Product Found @endif</h5>
                @endforelse
                </div><!-- /.home-owl-carousel -->
            </div><!-- /.product-slider -->
        </div><!-- /.tab-pane -->
...
<section class="section featured-product wow fadeInUp">
    <h3 class="section-title">@if (session()->get('language') == 'bangla')
        {{ $skip_category_0->category_name_bn }} @else {{ $skip_category_0->category_name_en }} @endif</h3>
    <div class="owl-carousel featureds home-owl-carousel custom-carousel owl-theme outer-top-xs">
...
<section class="section featured-product wow fadeInUp">
    <h3 class="section-title">@if (session()->get('language') == 'bangla')
        {{ $skip_category_1->category_name_bn }} @else {{ $skip_category_1->category_name_en }} @endif</h3>
    <div class="owl-carousel featureds home-owl-carousel custom-carousel owl-theme outer-top-xs">
...
<section class="section featured-product wow fadeInUp">
    <h3 class="section-title">
        ...
        {{ $skip_category_2->category_name_bn }}
         @else {{ $skip_category_2->category_name_en }} 
         @endif
         @endif
     </h3>
    <div class="owl-carousel featureds home-owl-carousel custom-carousel owl-theme outer-top-xs">
